...
public abstract class Hilt_ContentBrowserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ContentBrowserFragment() {
    super();
  }

  Hilt_ContentBrowserFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ContentBrowserFragment_GeneratedInjector) this.generatedComponent()).injectContentBrowserFragment(UnsafeCasts.<ContentBrowserFragment>unsafeCast(this));
    }
  }
