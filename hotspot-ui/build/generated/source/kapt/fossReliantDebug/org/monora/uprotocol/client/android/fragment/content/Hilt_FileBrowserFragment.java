...
public abstract class Hilt_FileBrowserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FileBrowserFragment() {
    super();
  }

  Hilt_FileBrowserFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FileBrowserFragment_GeneratedInjector) this.generatedComponent()).injectFileBrowserFragment(UnsafeCasts.<FileBrowserFragment>unsafeCast(this));
    }
  }
