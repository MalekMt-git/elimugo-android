...
public abstract class Hilt_AcceptClientFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AcceptClientFragment_GeneratedInjector) this.generatedComponent()).injectAcceptClientFragment(UnsafeCasts.<AcceptClientFragment>unsafeCast(this));
    }
  }
