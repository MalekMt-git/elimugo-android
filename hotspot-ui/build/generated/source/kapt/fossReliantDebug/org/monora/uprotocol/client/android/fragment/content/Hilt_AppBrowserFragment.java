...
public abstract class Hilt_AppBrowserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AppBrowserFragment() {
    super();
  }

  Hilt_AppBrowserFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppBrowserFragment_GeneratedInjector) this.generatedComponent()).injectAppBrowserFragment(UnsafeCasts.<AppBrowserFragment>unsafeCast(this));
    }
  }
