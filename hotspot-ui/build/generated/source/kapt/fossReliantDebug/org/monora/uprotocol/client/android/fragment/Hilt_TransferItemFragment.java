...
public abstract class Hilt_TransferItemFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TransferItemFragment_GeneratedInjector) this.generatedComponent()).injectTransferItemFragment(UnsafeCasts.<TransferItemFragment>unsafeCast(this));
    }
  }
