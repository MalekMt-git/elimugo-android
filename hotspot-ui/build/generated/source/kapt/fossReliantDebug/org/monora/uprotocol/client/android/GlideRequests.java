...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof org.monora.uprotocol.client.android.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new org.monora.uprotocol.client.android.GlideOptions().apply(toSet));
    }
  }
}
