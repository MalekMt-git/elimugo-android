...
public abstract class Hilt_TransferDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TransferDetailsFragment() {
    super();
  }

  Hilt_TransferDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TransferDetailsFragment_GeneratedInjector) this.generatedComponent()).injectTransferDetailsFragment(UnsafeCasts.<TransferDetailsFragment>unsafeCast(this));
    }
  }
