...
public abstract class Hilt_AudioBrowserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AudioBrowserFragment() {
    super();
  }

  Hilt_AudioBrowserFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AudioBrowserFragment_GeneratedInjector) this.generatedComponent()).injectAudioBrowserFragment(UnsafeCasts.<AudioBrowserFragment>unsafeCast(this));
    }
  }
