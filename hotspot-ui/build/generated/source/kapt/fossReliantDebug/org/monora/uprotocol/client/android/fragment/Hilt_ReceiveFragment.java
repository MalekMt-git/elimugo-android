...
public abstract class Hilt_ReceiveFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReceiveFragment() {
    super();
  }

  Hilt_ReceiveFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReceiveFragment_GeneratedInjector) this.generatedComponent()).injectReceiveFragment(UnsafeCasts.<ReceiveFragment>unsafeCast(this));
    }
  }
