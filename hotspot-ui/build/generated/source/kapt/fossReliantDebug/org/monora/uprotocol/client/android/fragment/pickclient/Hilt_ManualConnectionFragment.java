...
public abstract class Hilt_ManualConnectionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ManualConnectionFragment() {
    super();
  }

  Hilt_ManualConnectionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ManualConnectionFragment_GeneratedInjector) this.generatedComponent()).injectManualConnectionFragment(UnsafeCasts.<ManualConnectionFragment>unsafeCast(this));
    }
  }
