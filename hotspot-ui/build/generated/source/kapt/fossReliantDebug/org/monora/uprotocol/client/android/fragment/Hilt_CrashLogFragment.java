...
public abstract class Hilt_CrashLogFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CrashLogFragment_GeneratedInjector) this.generatedComponent()).injectCrashLogFragment(UnsafeCasts.<CrashLogFragment>unsafeCast(this));
    }
  }
