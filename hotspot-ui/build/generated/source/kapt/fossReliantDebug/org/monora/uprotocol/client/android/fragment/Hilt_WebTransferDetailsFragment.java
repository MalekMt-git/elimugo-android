...
public abstract class Hilt_WebTransferDetailsFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WebTransferDetailsFragment_GeneratedInjector) this.generatedComponent()).injectWebTransferDetailsFragment(UnsafeCasts.<WebTransferDetailsFragment>unsafeCast(this));
    }
  }
