...
public abstract class Hilt_PickClientFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PickClientFragment() {
    super();
  }

  Hilt_PickClientFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PickClientFragment_GeneratedInjector) this.generatedComponent()).injectPickClientFragment(UnsafeCasts.<PickClientFragment>unsafeCast(this));
    }
  }
