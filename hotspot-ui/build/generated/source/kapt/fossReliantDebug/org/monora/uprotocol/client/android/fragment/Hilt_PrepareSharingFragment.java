...
public abstract class Hilt_PrepareSharingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrepareSharingFragment() {
    super();
  }

  Hilt_PrepareSharingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrepareSharingFragment_GeneratedInjector) this.generatedComponent()).injectPrepareSharingFragment(UnsafeCasts.<PrepareSharingFragment>unsafeCast(this));
    }
  }
