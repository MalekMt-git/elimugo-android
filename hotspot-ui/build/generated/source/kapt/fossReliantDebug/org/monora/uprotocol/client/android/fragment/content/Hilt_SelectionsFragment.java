...
public abstract class Hilt_SelectionsFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SelectionsFragment_GeneratedInjector) this.generatedComponent()).injectSelectionsFragment(UnsafeCasts.<SelectionsFragment>unsafeCast(this));
    }
  }
