...
public class LayoutClientConnectionBindingImpl extends LayoutClientConnectionBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_offline, 3);
        sViewsWithIds.put(R.id.progress, 4);
        sViewsWithIds.put(R.id.retryButton, 5);
    }
    // views
    @NonNull
    ...
    public LayoutClientConnectionBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private LayoutClientConnectionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
