...
public abstract class Hilt_LicensesFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LicensesFragment_GeneratedInjector) this.generatedComponent()).injectLicensesFragment(UnsafeCasts.<LicensesFragment>unsafeCast(this));
    }
  }
