...
public abstract class Hilt_ClientConnectionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClientConnectionFragment() {
    super();
  }

  Hilt_ClientConnectionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClientConnectionFragment_GeneratedInjector) this.generatedComponent()).injectClientConnectionFragment(UnsafeCasts.<ClientConnectionFragment>unsafeCast(this));
    }
  }
