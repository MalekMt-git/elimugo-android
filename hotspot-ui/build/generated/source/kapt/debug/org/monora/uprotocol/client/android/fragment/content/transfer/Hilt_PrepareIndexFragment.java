...
public abstract class Hilt_PrepareIndexFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrepareIndexFragment_GeneratedInjector) this.generatedComponent()).injectPrepareIndexFragment(UnsafeCasts.<PrepareIndexFragment>unsafeCast(this));
    }
  }
