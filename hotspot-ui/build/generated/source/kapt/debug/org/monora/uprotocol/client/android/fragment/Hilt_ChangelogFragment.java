...
public abstract class Hilt_ChangelogFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChangelogFragment_GeneratedInjector) this.generatedComponent()).injectChangelogFragment(UnsafeCasts.<ChangelogFragment>unsafeCast(this));
    }
  }
