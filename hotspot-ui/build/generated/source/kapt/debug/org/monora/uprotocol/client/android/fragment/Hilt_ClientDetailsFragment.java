...
public abstract class Hilt_ClientDetailsFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClientDetailsFragment_GeneratedInjector) this.generatedComponent()).injectClientDetailsFragment(UnsafeCasts.<ClientDetailsFragment>unsafeCast(this));
    }
  }
