...
public abstract class Hilt_BarcodeScannerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BarcodeScannerFragment() {
    super();
  }

  Hilt_BarcodeScannerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BarcodeScannerFragment_GeneratedInjector) this.generatedComponent()).injectBarcodeScannerFragment(UnsafeCasts.<BarcodeScannerFragment>unsafeCast(this));
    }
  }
