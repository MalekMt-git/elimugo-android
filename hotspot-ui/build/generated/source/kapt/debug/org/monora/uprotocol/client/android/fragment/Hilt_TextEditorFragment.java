...
public abstract class Hilt_TextEditorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TextEditorFragment() {
    super();
  }

  Hilt_TextEditorFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TextEditorFragment_GeneratedInjector) this.generatedComponent()).injectTextEditorFragment(UnsafeCasts.<TextEditorFragment>unsafeCast(this));
    }
  }
