...
public abstract class Hilt_FilePickerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FilePickerFragment() {
    super();
  }

  Hilt_FilePickerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FilePickerFragment_GeneratedInjector) this.generatedComponent()).injectFilePickerFragment(UnsafeCasts.<FilePickerFragment>unsafeCast(this));
    }
  }
