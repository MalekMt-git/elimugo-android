...
public abstract class Hilt_ManageClientsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ManageClientsFragment() {
    super();
  }

  Hilt_ManageClientsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ManageClientsFragment_GeneratedInjector) this.generatedComponent()).injectManageClientsFragment(UnsafeCasts.<ManageClientsFragment>unsafeCast(this));
    }
  }
