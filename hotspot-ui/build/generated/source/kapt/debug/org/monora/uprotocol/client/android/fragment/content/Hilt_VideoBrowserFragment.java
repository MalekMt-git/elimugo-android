...
public abstract class Hilt_VideoBrowserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VideoBrowserFragment() {
    super();
  }

  Hilt_VideoBrowserFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VideoBrowserFragment_GeneratedInjector) this.generatedComponent()).injectVideoBrowserFragment(UnsafeCasts.<VideoBrowserFragment>unsafeCast(this));
    }
  }
