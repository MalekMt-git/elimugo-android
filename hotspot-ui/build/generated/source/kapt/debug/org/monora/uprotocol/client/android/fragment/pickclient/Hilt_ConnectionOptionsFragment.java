...
public abstract class Hilt_ConnectionOptionsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ConnectionOptionsFragment() {
    super();
  }

  Hilt_ConnectionOptionsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConnectionOptionsFragment_GeneratedInjector) this.generatedComponent()).injectConnectionOptionsFragment(UnsafeCasts.<ConnectionOptionsFragment>unsafeCast(this));
    }
  }
