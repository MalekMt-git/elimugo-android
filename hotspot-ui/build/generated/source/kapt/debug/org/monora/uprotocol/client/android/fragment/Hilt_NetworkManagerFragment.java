...
public abstract class Hilt_NetworkManagerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NetworkManagerFragment() {
    super();
  }

  Hilt_NetworkManagerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NetworkManagerFragment_GeneratedInjector) this.generatedComponent()).injectNetworkManagerFragment(UnsafeCasts.<NetworkManagerFragment>unsafeCast(this));
    }
  }
