...
public abstract class Hilt_ImageBrowserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImageBrowserFragment() {
    super();
  }

  Hilt_ImageBrowserFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImageBrowserFragment_GeneratedInjector) this.generatedComponent()).injectImageBrowserFragment(UnsafeCasts.<ImageBrowserFragment>unsafeCast(this));
    }
  }
