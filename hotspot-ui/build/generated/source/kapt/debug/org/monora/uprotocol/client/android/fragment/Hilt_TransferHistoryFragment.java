...
public abstract class Hilt_TransferHistoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TransferHistoryFragment() {
    super();
  }

  Hilt_TransferHistoryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TransferHistoryFragment_GeneratedInjector) this.generatedComponent()).injectTransferHistoryFragment(UnsafeCasts.<TransferHistoryFragment>unsafeCast(this));
    }
  }
