...
public abstract class Hilt_SharingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SharingFragment() {
    super();
  }

  Hilt_SharingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SharingFragment_GeneratedInjector) this.generatedComponent()).injectSharingFragment(UnsafeCasts.<SharingFragment>unsafeCast(this));
    }
  }
