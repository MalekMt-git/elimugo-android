...
public abstract class Hilt_IntroductionProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_IntroductionProfileFragment() {
    super();
  }

  Hilt_IntroductionProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IntroductionProfileFragment_GeneratedInjector) this.generatedComponent()).injectIntroductionProfileFragment(UnsafeCasts.<IntroductionProfileFragment>unsafeCast(this));
    }
  }
