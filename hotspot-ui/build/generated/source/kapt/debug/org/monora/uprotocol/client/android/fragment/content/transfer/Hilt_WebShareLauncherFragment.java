...
public abstract class Hilt_WebShareLauncherFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WebShareLauncherFragment_GeneratedInjector) this.generatedComponent()).injectWebShareLauncherFragment(UnsafeCasts.<WebShareLauncherFragment>unsafeCast(this));
    }
  }
