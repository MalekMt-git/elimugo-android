...
public abstract class Hilt_ProfileEditorFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProfileEditorFragment_GeneratedInjector) this.generatedComponent()).injectProfileEditorFragment(UnsafeCasts.<ProfileEditorFragment>unsafeCast(this));
    }
  }
