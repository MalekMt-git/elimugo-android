...
public data class TransferDetailsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): TransferDetailsFragmentArgs {
      bundle.setClassLoader(TransferDetailsFragmentArgs::class.java.classLoader)
      val __transfer : Transfer?
      if (bundle.containsKey("transfer")) {
        if (Parcelable::class.java.isAssignableFrom(Transfer::class.java) ||
            Serializable::class.java.isAssignableFrom(Transfer::class.java)) {
          __transfer = bundle.get("transfer") as Transfer?
        } else {
          throw UnsupportedOperationException(Transfer::class.java.name +
              " must implement Parcelable or Serializable or must be an Enum.")
        }
      ...
      return TransferDetailsFragmentArgs(__transfer)
    }
  }
}
