...
public class AcceptClientFragmentDirections private constructor() {
  private data class ActionAcceptClientFragmentToClientConnectionFragment(
    public val client: UClient,
    public val clientAddress: UClientAddress? = null
  ) : NavDirections {
    public override fun getActionId(): Int =
        R.id.action_acceptClientFragment_to_clientConnectionFragment
  ...
  public companion object {
    public fun actionAcceptClientFragmentToClientConnectionFragment(client: UClient,
        clientAddress: UClientAddress? = null): NavDirections =
        ActionAcceptClientFragmentToClientConnectionFragment(client, clientAddress)
